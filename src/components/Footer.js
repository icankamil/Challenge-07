...
<div className="row">
  <div className="col-sm-3">
    <small>Jalan Kangkung Kidul no. 18 Lingkar Selatan, Lengkong Bandung</small>
    <br />
  ...
  <div className="col-sm-2">
    <small> <a href="#ourservices" className="btn-outline-theme">Our Services</a></small>
    <br />
    <small> <a href="#whyus" className="btn-outline-theme">Why Us</a></small>
    <br />
     <small><a href="#testimonial" className="btn-outline-theme">Testimonial</a></small>
    <br />
    <small><a href="#FAQ" className="btn-outline-theme">FAQ</a></small>
  </div>
