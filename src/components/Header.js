...
<button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
  ...
  <div className="offcanvas-body justify-content-end" id="offcanvasRight">
<ul className="navbar-nav mb-2 mb-lg-0 gap-4">
       <li className="nav-item">
        <a href="#ourservices" className="nav-link btn-outline-theme">Our Services</a>
        </li>
       <li className="nav-item">
        <a href="#whyus" className="nav-link btn-outline-theme">Why Us</a>
        </li>
       <li className="nav-item">
        <a href="#testimonial" className="nav-link btn-outline-theme">Testimonial</a>
        </li>
      <li className="nav-item">
        <a href="#FAQ" className="nav-link btn-outline-theme">FAQ</a>
        </li>
      <li className="nav-item">
        <a href="register.html" className="nav-link btn btn-color-theme pl-3 pr-3">Register</a>
      </li>
</ul>
</div>
</div>
...
<div className= "mt-5">
  ...
  <img src="images/thumbnail.png" className="mobil img-fluid" alt="" />
  </div>
  </div>
  </div>
  </div>
